...
function Home() {
  return (
    <div className="grid grid-cols-4 gap-5 px-6">
      ...
      <div className="bg-[url('/src/assets/img/projects_background.jpg')] bg-cover rounded-lg shadow-xl min-h-[300px] col-span-4 md:col-span-2 flex justify-center items-center">
        <h2 className="font-interBold text-5xl text-center md:text-7xl text-white text-shadow-md">
          Mes projets
        </h2>
      </div>
      <div className="overflow-hidden rounded-lg shadow-xl col-span-4 md:col-span-2 ">
